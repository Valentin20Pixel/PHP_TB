...
check.addEventListener("click", function verif(event) {
    ...
    $sexem = document.getElementById("masculin").checked;
    $sexef = document.getElementById("feminin").checked;
    $naiss = document.getElementById("naissance").value;
    $CP = document.getElementById("code").value;
    $adrs = document.getElementById("adresse").value;
    $city = document.getElementById("ville").value;
    $email = document.getElementById("mail").value;
    $sujet = document.getElementById("sujet").value;
    $question = document.getElementById("question").value;
    $accpt =document.getElementById("accepte").checked;
